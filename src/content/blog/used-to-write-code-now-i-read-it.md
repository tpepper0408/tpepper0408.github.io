---
title: 'I Used to Write Code, Now I Read It'
description: 'Coming back to leading a team made me realise something uncomfortable. I spend most of my time reading code, not writing it. Can I still call myself hands-on?'
pubDate: 2026-04-04
tags: ['return-to-engineering', 'technical-leadership', 'engineering-craft']
---
...
![Someone at a computer looking contemplative and thinking about how rusty they have become at coding.](../../assets/images/reading_writing/RustyEngineeringLeader.png)
...
![An image of a person finding creativity through leading others, communicating, mentoring and discussing code.](../../assets/images/reading_writing/CreativityThroughLeading.png)
...
![An image of a person who is at a crossroads between a team craftsperson and a code craftsperson.](../../assets/images/reading_writing/CodeCraftVsTeamCraft.png)
...
When I say I'm not hands-on, what I really mean is I feel _distant from the craft_. Everything I do as a technical leader is less tangible than writing code. There are pockets of creativity in what I do but it's not the craft I learnt to get here. Somewhere along the way I stopped being the person who creates code and became the person who evaluates it.

<br/>

Over time I've gotten really good at reading code and the activities that come along with that. There's still a little voice in my head that says "Could I have written this code?". I know the answer is "yes, but slower than the person who wrote it". I'm a rusty writer but a good reader. That little voice is _imposter syndrome_. Part of the [return to engineering](/tags/return-to-engineering) series has been for me to confront that voice and get in touch with that craftsperson feeling again.
...
I think I'm a _team craftsperson_, not as much of a code craftsperson right now... and that's OK. However, understanding how best to craft a team does mean knowing what it feels like to be a craftsperson in your team. You need to dive in every so often to get that feeling again and feel the friction firsthand. You need to know how to motivate and inspire the craft in your team and the best way to do that is to be a credible software engineer yourself.
